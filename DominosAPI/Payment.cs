...
namespace DominoSharp
{
    ...
    public class Payment
    {
        ...
        public static JsonData GetCardObject(double paymentAmount)
        {
            string json = @"
            {
                ""Type""         : ""CreditCard"",
            ...
            // ALSO DoorDebit and DoorCredit
            json = json.Replace("{amt}", paymentAmount.ToString("0.00"));
        ...
        public static JsonData GetPaymentJson(PaymentType payment)
        {
            string pStr;
            switch (payment)
            {
                case PaymentType.Cash: pStr = "Cash"; break;
                case PaymentType.DoorCredit: pStr = "DoorCredit"; break;
                case PaymentType.DoorDebit: pStr = "DoorDebit"; break;
            ...
            return JsonMapper.ToObject(json.Replace("{ptype}", pStr));
        }
    }
}
