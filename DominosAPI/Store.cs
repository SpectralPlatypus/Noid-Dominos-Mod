...
namespace DominoSharp
{
    ...
    public class Store
    {
        ...
        public Store(string ID, JsonData array, URLs.Country c)
        {
            this.ID = ID;
            this.data = array;
            this.country = c;
        ...
        /// <param name="array">The JObject of data about the store</param>
        public Store(string ID, JsonData array)
        {
            this.ID = ID;
            this.data = array;
        ...
        public Menu ParseGetMenu(JsonData data)
        {
            return new Menu(data, country);
        }
        #endregion
