namespace DominoSharp
{
    ...
    public class URLs
    {
        ...
        /// <param name="c">The country to search in</param>
        /// <returns></returns>
        public static string trackBase(Country c)
        {
            return trackPrefix(c);
        }
        ...
        {
            return trackPrefix(c) + "/v2/orders?phonenumber={phone}";
        }

        public static string refererURL(Country c)
        {
            return "https://order.dominos." + (c == Country.USA ? "com" : "ca") + "/en/pages/order/";
        }
        ...
        {
            string baseUrl = (c == Country.CANADA) ? "https://api.dominos.ca" : "https://tracker.dominos.com";
         
            return baseUrl + "/tracker-presentation-service/";
        }
        #endregion
        #endregion
    }
